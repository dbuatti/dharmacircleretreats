...
import { DietarySelect } from "@/components/DietarySelect"; // Import the new component
...
const PublicRegistration = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.accommodation_plan) {
      setError("Please select your accommodation plan.");
      toast.error("Accommodation plan required");
      return;
    }

    if (!formData.transportation_plan) {
      setError("Please select your transportation plan.");
      toast.error("Transportation plan required");
      return;
    }
    ...
    try {
      const insertData = {
        ...
        transportation_plan: formData.transportation_plan,
        retreat_id: id,
        source: "public",
        ...
        {session ? (
          ...
          <div className="text-center">
            ...
            >
              ...
              <span className="font-semibold">Sign in with Google (Optional)</span>
            </Button>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="full_name" className="text-[10px] uppercase tracking-widest text-gray-500">
                ...
                <div className="space-y-2 border-t pt-4">
                  <Label htmlFor="notes" className="text-[10px] uppercase tracking-widest text-gray-500">
                    Additional Notes
                  </Label>
                  <Textarea 
                    id="notes" 
